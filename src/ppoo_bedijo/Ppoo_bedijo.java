...
public class Ppoo_bedijo {
    ...
    public static void main(String[] args) throws SQLException, ParseException {
        ...
        while (continuer) {
            System.out.println("Que souhaitez-vous faire ensuite ?");
            System.out.println("1. Créer un nouveau client");
            System.out.println("2. Créer un nouveau produit");
            System.out.println("3. Effectuer une souscription");
            System.out.println("4. Afficher la liste des SMS envoyés");
            System.out.println("5. Créer un client particulier");
            ...
            switch (choix) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    // Afficher la liste des SMS déjà envoyés
                ...
                case 6:
                    ...
                    break;
                default:
                    System.out.println("Choix invalide. Veuillez saisir un numéro de menu valide.");
            }
        }
...
// Afficher la liste des SMS
       ...
       /* ClientParticulierControleur clientParticulierController = new ClientParticulierControleur();
        ...
        clientParticulierControleur .addClientParticulier(client1);*/
